					...
					<div class="row">
						<div class="col-12">
							...
							<ul class="bread-list">
								...
								<li class="active">Edit Pharmacy</li>
							</ul>
						</div>
					</div>
				</div>
...
if (isset($_POST['btn'])) {
    ...
    if ($result[0]['email'] != $email) {
        $verif = $controller->isEmailUnique($email);

        if ($verif) {
            $user = new user();
            $user->doctor($nom, $prenom, $email, $pwd, '', '', '', $adresse, "pharmacie");
