...
<body>
    ...
    <header class="header">
        ...
        if (isset($_POST['btn_forum'])) {
            ...
            $forumC = new frmC();
            $forum = new frm($auteur, $titre, $img, $texte_forum, $user_id);
            $update = $forumC->updateForum($forum, $id_forum);
            $url = 'showForum.php?id_forum=' . $id_forum;
            header('Location:' . $url);
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="contact-us-form">
                            <h2>Write here</h2>
                            <!-- Form -->
                            <form class="form" id="forum_form" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">

                                            <input type="text" name="name" id="name" placeholder="Your name" required="required" value="<?php foreach ($result as $row) {
                                                                                                                                            echo $row['auteur'];
                                                                                                                                        } ?>" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title" placeholder="title" required="required" value="<?php foreach ($result as $row) {
                                                                                                                                            echo $row['titre'];
                                                                                                                                        } ?>" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group message">
                                            ...
                                            <input name="message" id="msg" rows="7" placeholder="Type Your Message Here" required="required" value="<?php foreach ($result as $row) {
                                                                                                                                                        echo $row['texte_forum'];
                                                                                                                                                    } ?>"></input>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="file" class="custom-file-input" name="file" required="required" id="fileInput" style="display: none" value="<?php foreach ($result as $row) {
                                                                                                                                                                            echo $row['img'];
                                                                                                                                                                        } ?>" />
