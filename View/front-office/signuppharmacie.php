							...
							<div class="contact-us-form">
								...
								<form class="form" method="post" action="mail/mail.php">
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="form-group">
											  <input type="file" id="fileInput" class="custom-file-input" name="file" required="" style="display: none">
											  <button type="button" id="customButton" class="btn btn-primary">mettez votre cacher</button>
											</div>
										  </div>
										  <div class="col-lg-3">
