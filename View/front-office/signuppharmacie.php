	...
	<div class="breadcrumbs overlay">
		<div class="container">
			<div class="bread-inner">
				<div class="row">
					<div class="col-12">
						<h2>Signup Pharmacy</h2>
						<ul class="bread-list">
							<li><a href="index.php">Home</a></li>
							<li><i class="icofont-simple-right"></i></li>
							<li class="active">Signup Pharmacy</li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<input type="text" name="nom" id="firstNameInput" placeholder="name" required="" />
									...
									<div class="col-lg-6">
										<div class="form-group">
											<input type="text" name="prenom" placeholder="prenom" required="" id="lastNameInput" />
											<div id="error-message-lastname" style="color: red"></div>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group">
											<input type="text" name="adresse" placeholder="addresse" required="" id="adresse" />
...
"></div>
								...
								<div class="col-lg-6">
									<div class="form-group login-btn">
										<button class="btn" type="submit" name="btn" id="signupButton" disabled>
											Signup
										</button>
									</div>
									<?php
									...
									if (isset($_POST['btn'])) {
										if (empty($_POST['g-recaptcha-response'])) {
											...
											if ($result) {
												$user = new user();
												$user->pharmacy($nom, $prenom, $email, $pwd, "pharmacie", $adresse);
												$controller = new usersC();
	...
	<script src="../script/signuppharmacy.js"></script>
</body>
