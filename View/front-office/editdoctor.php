...
<body>
  ...
  $result = $controller->read($user_id);
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input type="text" name="nom" value="<?php echo $result[0]['nom']; ?>" id="firstNameInput" placeholder="firstName" required="" />
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input type="text" name="prenom" placeholder="lastName" value="<?php echo $result[0]['prenom']; ?>" required="" id="lastNameInput" />
                      <div id="error-message-lastname" style="color: red"></div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input type="email" name="email" placeholder="Email" value="<?php echo $result[0]['email']; ?>" required="" id="email" />
                      <div id="error-message-email" style="color: red"></div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input type="password" name="pwd" placeholder="pwd" value="<?php echo $result[0]['pwd']; ?>" required="" id="pwd" />
                      <div id="error-message-pwd" style="color: red"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 form-group">
                    <input type="text" id="select" name="specialite" value="<?php echo $result[0]['specialite']; ?>" placeholder="Specialite" />
                    <div id="error-message-category" style="color: red"></div>
                  </div>
                  <div class="col-lg-12">
                    <div class="form-group">
                      <input placeholder="experience" required="" name="experience" value="<?php echo $result[0]['experience']; ?>" id="experience" />
                    </div>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input type="file" class="custom-file-input" name="file" id="fileInput" style="display: none" />
