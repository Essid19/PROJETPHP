	...
	<section class="blog section" id="blog">
		<div class="container">
			...
			<center>
				...
				<form action="showForumm.php" method="POST">
					<input type="text" name="search" placeholder="Search forums...">
					<button type="submit" name="btn_search">Search <i class="fa fa-search"></i></button>
				</form>
			</center>
			<br> <br>
			<div class="row">
				...
				if (is_array($result) && !empty($result)) {
					...
					<!-- Single Blog -->
					<a href='login.php?id_forum={$row['id_forum']}'>
						<div class='single-news'>
							<div class='news-head'>
								<a href='login.php?id_forum={$row['id_forum']}'><img src='../../src/{$row['img']}' alt='#' style='max-width: 300px; height: 300px;'> </a>
								<hr style=' color:blue;'>
								</div>
							<div class='news-body'>
								<div class='news-content'>
									<span > <span style='color: #3498db; font-size: 16px;'> Name:</span> {$row['auteur']}</span> <br>
									<span><span style='color: #3498db; font-size: 16px;'>Forum's Title: </span><a href='login.php?id_forum={$row['id_forum']}'>{$row['titre']}</a></span> <br>
            ...
            <input type='hidden' name='id_forum' value='{$row['id_forum']}'>
					...
					<i style='color: black; background-color: white; width: 40px; height: 25px; border: 1px solid black; box-shadow: 6px 6px 5px #888; display: inline-block; text-decoration: none;border-radius: 5px;vertical-align: middle;'>
			...
			<div style='color: black; background-color: white; width: 40px; height: 25px; border: 1px solid black; box-shadow: 6px 6px 5px #888; display: inline-block; text-decoration: none;border-radius: 5px;vertical-align: middle;'>
