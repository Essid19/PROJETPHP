...
<body>
            ...
            <div class="contact-us-form">
              ...
              <form class="form" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input type="text" name="prenom" placeholder="lastName" required="" id="lastNameInput" />
                  ...
                  <div class="col-lg-6">
                    <div class="form-group login-btn">
                      <button class="btn" name="btn" type="submit" id="signupButton" disabled>
                        Signup
                      </button>
                    </div>
                    <?php
                    ...
                    if (isset($_POST['btn'])) {
                      ...
                      if ($result) {
                        $user = new user();
                        $user->doctor($nom, $prenom, $email, $pwd, "", "", "", "", "admin");
                        $controller = new usersC();
                        $controller->adduser($user);
                        echo '<script>window.location.href = "login.php";</script>';
                        exit;
                      } else {
                        echo '<div style="color: red;" class="alert alert-danger form-group mt-3">Email already exists!</div>';
                      }
                    }
  ...
  <script src="../script/signupadmin.js"></script>
</body>
