      ...
      if ($result && !empty($result)) {
        echo "<div class='container news-single' >
            ...
            <img src='../../src/{$result[0]['img']}' alt='#' style='width: 100%; height: 50%; ' />
                    ...
                    <a href='login.php?id_med={$result[0]['id_med']}' class='btn btn_primary' style='color: white; display: block; margin-top: 10px; background-color: transparent; border: 1px solid black; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); color:blue;'>Ajouter au panier</a>
