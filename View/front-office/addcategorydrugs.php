...
if (isset($_POST['btn_catg'])) {
  ...
  $category = new category($nom, $id_ph);

  $categoryC->addcateg($category);
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="contact-us-form">
              <h2>Add Here</h2>
              <!-- Form -->
              <form id="form_catg" class="form" method="post" action="">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input id="name" type="text" name="name" placeholder="category name" required="required" />
                  ...
                  <div class="col-lg-6">
                    <div class="form-group login-btn">
                      <button class="btn" name="btn_catg" type="submit">Add Category </button>
                    </div>
                  </div>
                  <div class="col-lg-3"></div>
                </div>
