...
$newread = new qtc();
$controller = new qtc();
$result = $newread->getcatById($id_catg);




if (isset($_POST['btn_catg'])) {
    $nom = $_POST['category'];
    $update = $controller->updatecatg($nom, $id_catg);
    if ($update == 1) {
        header('Location:dashpharmacie.php');
    }
}
//récuperer category
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="contact-us-form">
                            <h2>Update Here</h2>
                            <!-- Form -->
                            <form id="form_catg" class="form" method="post">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" name="category" value="<?php echo $result[0]['nom']; ?>">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group login-btn">
                                            <button class="btn" name="btn_catg" type="submit">Update Category </button>
                                        </div>
                                    </div>
                                    <div class="col-lg-3"></div>
                                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var form = document.getElementById("form_catg");
            form.addEventListener("submit", function(event) {
                ...
                const regexLettresChiffres = /^[a-zA-Z\s]+$/;
