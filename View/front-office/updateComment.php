...
$resultat = $comm->getCommentById($id_cmn);
if (isset($_POST['btn_cmn'])) {
  $id_forum = $_GET['id_forum'];
  $auteur = $_POST['name'];
  $texte_cmn = $_POST['message'];
  $cmnupdated = new cmn($auteur, $texte_cmn, $id_forum, $user_id);
  $comm->updateCmn($cmnupdated, $id_cmn);
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-4 col-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" placeholder="Your Full name" required="required" value="<?php foreach ($resultat as $row) {
                                                                                                                            echo $row['auteur'];
                                                                                                                          } ?>" />
                    ...
                    <div class="col-12">
                      <div class="form-group message">
                        ...
                        <input name="message" id="msg" rows="7" placeholder="Put Your Message Here" required="required" value="<?php foreach ($resultat as $row) {
                                                                                                                                  echo $row['texte_cmn'];
                                                                                                                                } ?>"></input>
                    ...
                    <div class='col-12'>
                      <div class='form-group button'>
                        <button type='submit' id='btn_cmn' name='btn_cmn' class='btn primary' enabled>
                          <i class='fa fa-send'></i>Update Comment
                        </button>
                      </div>
                    </div>
