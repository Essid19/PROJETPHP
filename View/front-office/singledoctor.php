...
if (isset($_POST['btn_cmn'])) {
  ...
  $commentC = new CmnC();
  $comment = new cmn($nom, $prenom, $email, $texte_cmn);
  $commentC->addCmn($comment);


  //echo "Commentaire ajouter avec succée";
} else {
  echo "impo de lire les données";
}


$newcommentC = new CmnC();
$result = $newcommentC->readC();
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-12">
          <div class="row">
            <div class="col-12">
              <div class="single-main">
                ...
                <h1 class="news-title">Experience</h1>
                <a href="reservation.php" class="btn btn_primary" style="color: white">Appointment</a>
                    ...
                    <div class="main">
                      ...
                      <div class="body">
                        ...
                        <div class="comment-meta">
                          <span class="meta"><i class="fa fa-calendar"></i>March 05,
                            2019</span><span class="meta"><i class="fa fa-clock-o"></i>03:38 AM</span>
                        </div>
                        <p>
          ...
          <!--yabda el commentaire-->
          <div class="col-12">
            <div class="comments-form">
              <h2>Leave Comments</h2>

              <!-- Contact Form -->
              <form class="form" id="cmn_form" method="post" action="singledoctor.php">
                <div class="row">
                  <div class="col-lg-4 col-md-4 col-12">
                    <div class="form-group">
                      <i class="fa fa-user"></i>
                      <input type="text" name="first-name" id="f_name" placeholder="First name" required="required" />
                  ...
                  <div class="col-lg-4 col-md-4 col-12">
                    <div class="form-group">
                      <i class="fa fa-user"></i>
                      <input type="text" name="last-name" id="l_name" placeholder="Last name" required="required" />
                  ...
                  <div class="col-12">
                    <div class="form-group button">
                      <button type="submit" id="btn_cmn" name="btn_cmn" class="btn primary" disabled>
