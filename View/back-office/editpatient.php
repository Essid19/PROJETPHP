...
if (isset($_POST['btn'])) {
    ...
    $user = new user();
    $user->doctor($nom, $prenom, $email, $pwd, $specialite, $experience, $img, "patient");
    $controller = new usersC();
                        ...
                        <form class="user" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <input type="password" name="pwd" value="<?php echo $result[0]['pwd']; ?>" class="form-control form-control-user"
